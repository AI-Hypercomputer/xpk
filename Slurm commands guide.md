...
Upload your training scripts and training data to the created storage.
...
Download llama 3.1 model weights
...
Just like in Slurm, you can submit jobs in XPK using the following methods: batch jobs, array jobs and interactive jobs.
 ...
 xpk run | srun - run CUDA in interactive mode
...
xpk batch | sbatch - run training script in batch mode
