...
[XPK] Task: `Fetching available memory on node` is implemented by the following command not running since it is a dry run. 
kubectl get node 0 -o jsonpath='{.status.allocatable.memory}'
[XPK] Temp file (dbe5ba17f447508c4b5e2a8d61b16c8e4335e584ea6752b9940cabf93b840050) content: 
apiVersion: v1
kind: Namespace
metadata:
  name: ray
      ...
      spec:
        ...
        - name: ray-head
          ...
          - containerPort: 8081
            name: multislice
  workerGroupSpecs:
    - replicas: 100 # TODO: Set min and max replicas
      numOfHosts: 1
      minReplicas: 100
      maxReplicas: 100
...
kubectl apply -f dbe5ba17f447508c4b5e2a8d61b16c8e4335e584ea6752b9940cabf93b840050
