...
# Running the command
```shell #golden
SUB_SLICING_ENABLED=true xpk cluster create --num-slices=1 --project=golden-project --zone=us-central1-a --cluster=golden-cluster --tpu-type=v6e-4x4 --reservation=golden-reservation --sub-slicing
```
<!--
$ SUB_SLICING_ENABLED=true xpk cluster create --num-slices=1 --project=golden-project --zone=us-central1-a --cluster=golden-cluster --tpu-type=v6e-4x4 --reservation=golden-reservation --sub-slicing
