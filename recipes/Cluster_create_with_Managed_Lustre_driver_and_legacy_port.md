...
# Running the command
```shell #golden
xpk cluster create --num-slices=1 --project=golden-project --zone=us-central1-a --cluster=golden-cluster --tpu-type=tpu7x-8 --enable-lustre-csi-driver --enable-legacy-lustre-port --spot
```
<!--
$ xpk cluster create --num-slices=1 --project=golden-project --zone=us-central1-a --cluster=golden-cluster --tpu-type=tpu7x-8 --enable-lustre-csi-driver --enable-legacy-lustre-port --spot
