...
# Running the command
```shell #golden
xpk cluster create-pathways --num-slices=1 --project=golden-project --zone=us-central1-a --enable-autoprovisioning --cluster=golden-cluster --tpu-type=tpu7x-8 --on-demand
```
<!--
$ xpk cluster create-pathways --num-slices=1 --project=golden-project --zone=us-central1-a --enable-autoprovisioning --cluster=golden-cluster --tpu-type=tpu7x-8 --on-demand
