...
const (
	serviceName             = "slice-controller-webhook-service"
	secretName              = "slice-controller-webhook-server-cert"
	secretNamespace         = "slice-controller-system"
	certDir                 = "/tmp/k8s-webhook-server/serving-certs"
	mutatingWebhookConfName = "slice-controller-mutating-webhook-configuration"
	caName                  = "slice-controller-ca"
	caOrg                   = "slice-controller"
)
