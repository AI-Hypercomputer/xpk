...
func WaitForLWSAvailability(ctx context.Context, k8sClient client.Client) {
	lcmKey := types.NamespacedName{Namespace: "lws-system", Name: "lws-controller-manager"}
	waitForOperatorAvailability(ctx, k8sClient, lcmKey)
}
