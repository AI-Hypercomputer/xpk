...
def construct_args(**kwargs: Any) -> Namespace:
  args_dict = dict(
      ...
      num_cubes=None,
      proxy_server_image='',
      custom_pathways_proxy_server_args='',
      server_image='',
      custom_pathways_server_args='',
      custom_pathways_worker_args='',
      pathways_gcs_location='gs://cloud-pathways-staging/tmp',
      elastic_slices=0,
      max_slice_restarts=1,
