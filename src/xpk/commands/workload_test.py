...
def test_workload_create_multi_container_for_super_slicing(
    workload_create_mocks: _WorkloadCreateMocks,
    mocker,
):
  """Tests that the generated YAML for a super-slicing workload correctly utilizes parallel_containers > 1."""
  ...
  # Explicitly simulate super-slicing being available
