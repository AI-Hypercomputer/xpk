...
class Storage:
  ...
  def __init__(self, data: dict):
    ...
    self.manifest: str | None = spec.get("manifest")
    self.pvc: str | None = spec.get("pvc")
    self.pv: str | None = spec.get("pv")
    self.bucket: str | None = self._get_bucket()

  def fields_as_list(self) -> list[bool | str | None]:
    """
  ...
  def _get_bucket(self) -> str:
    ...
    try:
      pv = client.read_persistent_volume(self.pv)
